		...
		<main>
			<div id="edit-modal" class="modal">
				<div class="modal-content">
					...
					<form:form action="editPromo.html" method="post" id="edit-form"
						...
						<input type="datetime-local" class="form-control mb-3"
							name="ngayBDStr" value="${khuyenMai.ngayBD }" required="required">
						<form:input type="hidden" path="ngayBD" />

						<label for="promo-end">End:</label>
						<input type="datetime-local" class="form-control mb-3"
							name="ngayKTStr" value="${khuyenMai.ngayKT }" required="required">
