				...
				<div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
					<div class="bg-white p-4 p-md-5 rounded shadow-sm">
						<div class="row gy-3 mb-5">
							...
							<div class="col-12">
								<h2
									class="fs-6 fw-normal text-center text-secondary m-0 px-md-5">${message}.</h2>
							</div>
						</div>
						<form action="<c:url value="/forgot-password"/>" method="POST">
							<div class="row gy-3 gy-md-4 overflow-hidden">
								<div class="col-12">
									<label for="email" class="form-label" style="position: unset;">Email
							...
							<div class="col-12">
								...
								<div class="d-flex gap-4 justify-content-center">
									<a href='<c:url value="/sign-in"/>'
										class="link-secondary text-decoration-none">Sign in</a> <a
										href='<c:url value="/sign-up"/>'
										class="link-secondary text-decoration-none">Sign up</a>
								</div>
							</div>
						</div>
					</div>
