...
<body>
	<section class="hero-section">
		...
		<div class="hero-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="<c:url value='/template/user/img/hero/hero-1.jpg'/>"></div>
            <div class="hs-item set-bg" data-setbg="<c:url value='/template/user/img/hero/hero-2.jpg'/>"></div>
            <div class="hs-item set-bg" data-setbg="<c:url value='/template/user/img/hero/hero-3.jpg'/>"></div>
        </div>
	</section>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="about-pic">
						<div class="row">
							<div class="col-sm-6">
								<img src="<c:url value='/template/user/img/about/about-1.jpg'/>" alt="">
							</div>
							<div class="col-sm-6">
								<img src="<c:url value='/template/user/img/about/about-2.jpg'/>" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="hp-room-items">
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value='/template/user/img/room/room-b1.jpg'/>"
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value='/template/user/img/room/room-b2.jpg'/>"
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value='/template/user/img/room/room-b3.jpg'/>"
					...
					<div class="col-lg-3 col-md-6">
						<div class="hp-room-item set-bg" data-setbg="<c:url value='/template/user/img/room/room-b4.jpg'/>"
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="testimonial-slider owl-carousel">
                        <div class="ts-item">
                            ...
                            <img src="<c:url value='/template/user/img/testimonial-logo.png'/>" alt="">
                        </div>
                        <div class="ts-item">
                            <p>After a construction project took longer than expected, my husband, my daughter and I
                                needed a place to stay for a few nights. As a Chicago resident, we know a lot about our
	...
	<section class="blog-section spad">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value='/template/user/img/blog/blog-1.jpg'/>"
				...
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value='/template/user/img/blog/blog-2.jpg'/>"
				...
				<div class="col-lg-4">
					<div class="blog-item set-bg" data-setbg="<c:url value='/template/user/img/blog/blog-3.jpg'/>"
